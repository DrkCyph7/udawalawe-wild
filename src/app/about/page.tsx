          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_1fr] lg:items-center">
            ...
            <Reveal direction="right" delay={100}>
              <TiltCard intensity={5}>
                <div
                  className="aspect-[4/5] overflow-hidden rounded-3xl relative"
          ...
          <Reveal delay={100}>
            <div className="mt-10">
              <Magnetic>
                <Link
                  to="/book"
                  className="inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-sm font-semibold transition-all duration-300 hover:scale-[1.03] bg-[oklch(0.70_0.12_85)] hover:bg-[oklch(0.80_0.08_85)] text-[oklch(0.22_0.02_135)] shadow-[0_4px_20px_oklch(0.70_0.12_85_/_0.4)]"
                >
