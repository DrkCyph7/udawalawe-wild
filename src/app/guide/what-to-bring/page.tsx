    ...
    <main className="pb-16 pt-24 sm:pt-32 lg:pb-24">
      <Section>
        ...
        <div className="mt-8 prose prose-forest max-w-none text-foreground/80">
          <p>
            Packing correctly for your Udawalawe safari ensures you stay comfortable and can fully
            enjoy the wildlife experience. Safaris take place in open-top 4x4 jeeps, meaning you
            will be exposed to the elements. Here is a practical checklist of what to bring.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Layers:</strong> If you are on a morning safari, the pre-dawn air is chilly.
              Bring a light sweater or fleece that you can remove as it warms up.
            </li>
            <li>
              <strong>Appropriate footwear:</strong> You will remain in the jeep for the duration of
              the safari, so comfortable sandals or trainers are perfectly fine.
            </li>
            <li>
              <strong>Sun protection:</strong> A wide-brimmed hat, sunglasses, and high-SPF
              sunscreen are essential, especially for afternoon safaris.
            </li>
            <li>
              <strong>Rain protection:</strong> If visiting during the wetter months, a light rain
              jacket or poncho is recommended.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Camera and lenses:</strong> Bring your best camera. A zoom lens (200mm or
              more) is highly recommended for wildlife photography.
            </li>
            <li>
            ...
            <li>
              <strong>Power bank:</strong> Safaris are long, and you will likely be taking many
              photos and videos. A fully charged power bank is very useful.
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Water:</strong> Stay hydrated. We provide bottled water, but bringing a
            ...
            <li>
              ...
              driver/guide (optional but appreciated for good service) or for small roadside
              purchases.
            </li>
          </ul>
          ...
          <div className="mt-12 bg-sand-200 p-6 rounded-xl border border-border">
            ...
            <p className="text-sm">
              Now that you know what to pack, the next step is securing your jeep.
            </p>
