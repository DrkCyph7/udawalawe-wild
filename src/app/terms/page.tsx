    ...
    <Section>
      ...
      <div className="mt-8 max-w-3xl space-y-6 text-sm leading-relaxed text-foreground/85">
        ...
        <p>
          ...
          with verified, licensed local safari jeep operators in and around Udawalawe National Park,
          Sri Lanka. Udawalawe Wild is not the Department of Wildlife Conservation (DWC) or the
          official national park authority.
        </p>
        ...
        <p>
          Udawalawe National Park is a natural wildlife sanctuary. Animals move freely within their
          natural habitat. Neither Udawalawe Wild nor any partner operator can guarantee specific
          animal sightings (including elephants, leopards, or specific bird species).
        </p>

        <h3 className="font-serif text-lg text-foreground">4. Park Rules & Guest Conduct</h3>
        <p>
          All guests must adhere strictly to the park rules enforced by the Department of Wildlife
          Conservation and our Ethical Safari Code. This includes remaining inside the safari
          vehicle at all times, refraining from feeding or disturbing animals, avoiding loud noises,
          and respecting driver instructions.
        </p>
        ...
        <p>
          ...
          traffic conditions, or unexpected vehicle breakdowns handled by partner operators, though
          we will always assist in resolving issues promptly.
        </p>

        <h3 className="font-serif text-lg text-foreground">7. Contact & Governing Law</h3>
        <p>
          These Terms are governed by the laws of Sri Lanka. For questions regarding these terms,
          reach us at hello@udawalawe-wild.com.
        </p>
      </div>
    </Section>
  </div>
