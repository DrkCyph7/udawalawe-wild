...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Terms of use for the Udawalawe Wild safari booking platform.",
      },
      ...
      <Section>
        ...
        <div className="mt-8 max-w-3xl space-y-6 text-sm leading-relaxed text-foreground/85">
          ...
          <p>
            ...
            vehicle at all times, refraining from feeding or disturbing animals, avoiding loud
            noises, and respecting driver instructions.
          </p>
