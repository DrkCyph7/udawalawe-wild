    ...
    <div className="section-dark min-h-[calc(100vh-80px)] pt-12 pb-24">
      <Section>
        ...
        <div className="mt-8 max-w-3xl space-y-6 text-sm leading-relaxed text-foreground/85">
          ...
          <p>
            Udawalawe Wild ("we," "our," or "us") operates an independent safari booking platform
            for Udawalawe National Park, Sri Lanka. This Privacy Policy outlines how we collect,
          ...
          <p>
            We collect information you voluntarily provide to us when submitting an enquiry or
            booking request, including:
          </p>
          ...
          <p>
            We do not sell, rent, or trade your personal information. To arrange your safari, we
            share relevant booking details (e.g. date, group size, pickup location, contact name)
            with the verified local safari operator assigned to your trip. We require all partner
            operators to handle your data confidentially and solely for trip fulfillment.
          </p>

          <h3 className="font-serif text-lg text-foreground">5. Payment Data Security</h3>
          <p>
            We do not collect, process, or store credit/debit card numbers or bank account details
            on our website. All payment arrangements are handled directly with your assigned local
