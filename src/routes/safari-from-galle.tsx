...
export const Route = createFileRoute("/safari-from-galle")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Safari from Galle to Udawalawe — Udawalawe Wild" },
      { name: "twitter:description", content: "Plan a private Udawalawe safari from Galle. Route notes, hill-country transfer options, and enquiry form." },
