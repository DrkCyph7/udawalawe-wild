...
export const Route = createFileRoute("/safari-from-hiriketiya")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plan a private Udawalawe safari from Hiriketiya. Short coastal route, timing, and enquiry form." },
      { property: "og:title", content: "Safari from Hiriketiya to Udawalawe" },
      { property: "og:description", content: "Private safaris from Hiriketiya with verified local operators." },
    ],
