...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Private, wildlife-first safaris with verified local partners, transparent pricing, and simple planning in Udawalawe National Park." },
      { property: "og:title", content: "Udawalawe Wild — Private safaris in Udawalawe" },
      { property: "og:description", content: "Verified local partners. Private jeeps. Transparent quotes. Wildlife-first experiences." },
    ...
    <>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-5 pb-16 pt-20 sm:px-8 sm:pb-24 sm:pt-28 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14 lg:pt-32">
          <div className="text-[color:var(--ivory)]">
            ...
            <p className="mt-5 max-w-lg text-base leading-relaxed text-[color:var(--ivory)]/85 sm:text-lg">
              Private, wildlife-first safaris with verified local partners,
              transparent pricing, and simple planning.
            </p>
      ...
      <Section>
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
          ...
          />
          <Link to="/safaris" className="text-sm font-medium text-primary underline underline-offset-4">
            Compare all options →
          </Link>
        </div>
      ...
      <div className="bg-[color:var(--sand)]/30">
        <Section>
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { t: "Clear pricing", d: "Fixed quotes before you confirm. No surprise fees at the gate." },
              { t: "Carefully selected partners", d: "Every operator is licensed, insured, and vetted for conduct." },
              { t: "Responsive planning", d: "Real replies on WhatsApp — usually within a few hours." },
      ...
      {/* FINAL CTA */}
      <section className="relative isolate overflow-hidden">
        <img src={landscape} alt="" aria-hidden loading="lazy" className="absolute inset-0 -z-10 h-full w-full object-cover" />
        ...
        <div className="mx-auto max-w-3xl px-5 py-24 text-center text-[color:var(--ivory)] sm:px-8 sm:py-32">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base text-[color:var(--ivory)]/85">
            Send us your dates. We'll come back with verified options and a fixed quote within one business day.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link to="/book" className="rounded-sm bg-[color:var(--terracotta)] px-6 py-3 text-sm font-medium text-[color:var(--ivory)]">
              Plan my safari
            </Link>
            <a href={waLink()} target="_blank" rel="noopener noreferrer" className="rounded-sm border border-[color:var(--ivory)]/50 px-6 py-3 text-sm font-medium text-[color:var(--ivory)]">
              Chat on WhatsApp
            </a>
          </div>
        </div>
